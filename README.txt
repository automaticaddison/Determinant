...
DeterminantDriver.java contains the main method and is the driver class for the application.
...
of the program and run using the command 'javac DeterminantDriver.java' + 'java DeterminantDriver' 
